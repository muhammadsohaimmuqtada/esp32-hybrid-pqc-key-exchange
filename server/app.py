...
AES_GCM_IV_SIZE = 12
AES_GCM_TAG_SIZE = 16
HANDSHAKE_PSK = b"REPLACE_WITH_32_BYTE_TEST_PSK_ONLY"
...
# Point this to your compiled libmlkem.so
mlkem_lib_path = os.environ.get("MLKEM_LIB_PATH", "../firmware/components/mlkem512/libmlkem.so")
try:
